export type RaceActionIcon = 'registration' | 'notice' | 'calendar' | 'facts' | 'ticket' | 'route' | 'family' | 'notes' | 'vote' | 'link' | 'location' | 'share';
...
const paths: Record<RaceActionIcon, string> = {
  ...
  route: '<path d="M4 19V5l5-2 6 2 5-2v14l-5 2-6-2-5 2Z"/><path d="M9 3v14M15 5v14"/>',
