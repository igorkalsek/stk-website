...
export const proposalFormLocales = {
  sl: {
    ...
    chooseType: 'Najprej izberite vrsto predloga', submit: 'Pošlji predlog', openingGoogleForm: 'Pošiljanje …', submitted: 'Predlog je bil poslan. Hvala za pomoč pri dopolnjevanju koledarja.', submitError: 'Predloga trenutno ni bilo mogoče poslati. Podatki so ostali v obrazcu; poskusite znova ali uporabite rezervno povezavo.', googleFormHandOff: 'Predlog bo poslan v pregled. Ostali boste na tej strani.', clear: 'Počisti obrazec', newProposal: 'Oddajte nov predlog', backToCalendar: 'Nazaj na koledar', cleanPath: '/dodaj-ali-popravi-tek/', calendarPath: '/', fallback: 'Težave z oddajo? Odprite predizpolnjen Google obrazec.', selected: 'Izbrani tek za popravek', back: 'Nazaj na stran teka', noSource: 'Izpolnite samo podatke, ki so pomembni za izbrano vrsto predloga.', errorTitle: 'Preverite označena polja:', sourceError: 'Vnesite celoten spletni naslov, na primer https://organizator.si/razpis.', dateError: 'Vnesite datum v obliki LLLL-MM-DD.', resetConfirm: 'Želite počistiti vnesene spremembe in obnoviti podatke izbranega teka?', sourceWarning: 'To je povezava na Slovenski Tekaški Koledar, ne na uradni vir dogodka. Dodajte stran organizatorja ali pustite polje prazno.', changeError: 'Označite vsaj en podatek, ki ga želite popraviti ali dopolniti.', selectedChanges: 'Izbrani podatki', contextTitle: 'Popravek ali dopolnitev za izbrani tek', currentDetails: 'Trenutno objavljeni podatki', missing: 'Ni podatka', correct: 'Popravi', add: 'Dopolni', addAnotherRace: 'Dodajte nov tek', sendOther: 'Drugo vprašanje ali sporočilo', showAllChanges: 'Prikažite vse možnosti', showFewerChanges: 'Prikažite manj možnosti', addMissingDetails: 'Dopolnite manjkajoče podatke', aboutProposal: 'O predlogu', aboutProposalHelper: 'Podatka pomagata pri preverjanju in pravilni obravnavi predloga.', otherCorrectionOptions: 'Druge možnosti popravka', basicDetails: 'Osnovni podatki', extraDetails: 'Dodatni podatki',
    labels: { proposalType: 'Tip predloga', date: 'Datum', title: 'Naziv prireditve', place: 'Kraj', region: 'Regija', officialSource: 'Uradni vir (neobvezno)', description: 'Opis oziroma podrobnosti', organizer: 'Ali ste organizator?', officialAnnouncement2026: 'Ali je za izbrano leto že objavljen uradni razpis ali uradna objava?', email: 'Kontaktni e-naslov', additionalData: 'Kaj želite popraviti ali dopolniti?', placeOptional: 'Kraj (neobvezno)' },
    helpers: { officialSource: 'Povezava do razpisa, strani organizatorja ali prijavnega portala.', newDescription: 'Dodajte samo informacije, ki jih ni mogoče vnesti v zgornja polja.', correctionDescription: 'Navedite obstoječi in pravilen podatek.', additionalData: 'Izberite osnovni popravek ali spodaj vnesite dodatne podatke v ločena polja.', additionalDescription: 'Za osnovne popravke navedite obstoječi in pravilen podatek. Dodatne podatke vnesite v ločena polja.', email: 'Uporabi se le za morebitna vprašanja o predlogu in se ne objavi.', privacy: 'Več o projektu in zasebnosti.' },
    ...
    dynamicLabels: { newDescription: 'Opis teka in dodatne informacije', correctionDescription: 'Kaj je napačno in kako naj se podatek popravi?', additionalDescription: 'Vnesite manjkajoče ali pravilne podatke' },
  ...
  en: {
    ...
    chooseType: 'First choose the proposal type', submit: 'Send proposal', openingGoogleForm: 'Sending …', submitted: 'Your submission has been sent. Thank you for helping us improve the calendar.', submitError: 'The submission could not be sent right now. Your details are still in the form; try again or use the backup link.', googleFormHandOff: 'The proposal will be submitted for review. You will remain on this page.', clear: 'Clear form', newProposal: 'Submit a new proposal', backToCalendar: 'Back to calendar', cleanPath: '/en/add-or-correct-race/', calendarPath: '/en/', fallback: 'Having trouble submitting? Open the prefilled Google form.', selected: 'Selected race for correction', back: 'Back to race page', noSource: 'Fill in only the details that matter for the selected proposal type.', errorTitle: 'Check the highlighted fields:', sourceError: 'Enter the full web address, for example https://organizator.si/razpis.', dateError: 'Enter the date in YYYY-MM-DD format.', resetConfirm: 'Clear your changes and restore the selected race details?', sourceWarning: 'This is a Slovenski Tekaški Koledar link, not the official race source. Add the organiser page or leave the field empty.', changeError: 'Select at least one detail you would like to correct or add.', selectedChanges: 'Selected details', contextTitle: 'Correct or add details for the selected race', currentDetails: 'Currently published details', missing: 'Not available', correct: 'Correct', add: 'Add', addAnotherRace: 'Add a new race', sendOther: 'Other question or message', showAllChanges: 'Show all options', showFewerChanges: 'Show fewer options', addMissingDetails: 'Add missing details', aboutProposal: 'About the proposal', aboutProposalHelper: 'These details help verify and route the proposal correctly.', otherCorrectionOptions: 'Other correction options', basicDetails: 'Basic details', extraDetails: 'Additional details',
    labels: { proposalType: 'Proposal type', date: 'Date', title: 'Race name', place: 'Place', region: 'Region', officialSource: 'Official source (optional)', description: 'Description or details', organizer: 'Are you the organizer?', officialAnnouncement2026: 'Has the official announcement for the selected year already been published?', email: 'Contact email', additionalData: 'What would you like to correct or add?', placeOptional: 'Place (optional)' },
    helpers: { officialSource: 'Link to the race announcement, organiser page or registration portal.', newDescription: 'Add only information that cannot be entered in the fields above.', correctionDescription: 'Include the existing detail and the correct detail.', additionalData: 'Select a basic correction or enter additional details in the separate fields below.', additionalDescription: 'For basic corrections, include the existing and correct detail. Enter additional details in the separate fields.', email: 'It is used only for possible questions about the proposal and is not published.', privacy: 'More about the project and privacy.' },
    ...
    dynamicLabels: { newDescription: 'Race description and additional information', correctionDescription: 'What is wrong and how should it be corrected?', additionalDescription: 'Enter the missing or correct details' },
